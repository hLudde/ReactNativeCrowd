...
class Username extends Component {
  ...
  render() {
    return (
        <View>
          <TextInput style={styles.TextInputForm} onChangeText={(text) => this.setState({text})}
        value={this.state.text} placeholder="username"/>
        </View>
    );
  }
}
class Password extends Component {
  ...
  render() {
    return (
        <View>
          <TextInput style={styles.TextInputForm} onChangeText={(text) => this.setState({text})}
        value={this.state.text} placeholder="password" secureTextEntry={true}/>
        </View>
    );
  }
}
